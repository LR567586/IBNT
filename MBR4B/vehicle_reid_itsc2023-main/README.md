...
To train:
```console
python main.py --model_arch MBR_4G --config ./config_BoT_Veri776.yaml
```

Test:
```console
python D:\MBR4B\vehicle_reid_itsc2023-main\teste.py --path_weights D:\MBR4B\logs\Veri776\MBR_4G\0
```

...
if __name__ == "__main__":
    ...
    if data['dataset']== "VehicleID":
        data_q = CustomDataSet4VehicleID(r'D:\MBR4B\vehicle_reid_itsc2023-main\dataset\VehicleID_V1.0\VehicleID_V1.0\train_test_split\test_list_800.txt', data['ROOT_DIR'], is_train=False, mode="q", transform=teste_transform)
        data_g = CustomDataSet4VehicleID(r'D:\MBR4B\vehicle_reid_itsc2023-main\dataset\VehicleID_V1.0\VehicleID_V1.0\train_test_split\test_list_800.txt', data['ROOT_DIR'], is_train=False, mode="g", transform=teste_transform)
        data_train = CustomDataSet4VehicleID(r"D:\MBR4B\vehicle_reid_itsc2023-main\dataset\VehicleID_V1.0\VehicleID_V1.0\train_test_split\train_list.txt", data['ROOT_DIR'], is_train=True, transform=train_transform)

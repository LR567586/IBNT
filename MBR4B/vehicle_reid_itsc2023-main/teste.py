...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default=None, help='Choose one of[Veri776, VERIWILD, VehicleID]')
    parser.add_argument('--model_arch', default=None, help='Model Architecture')
    parser.add_argument('--path_weights', default=r'D:\MBR4B\logs\VehicleID\Hybrid_2B\1\best_mAP.pt', help='Path to *.pth/*.pt loading weights file')
    ...
    if args.config:
        ...
        # 获取权重文件所在的目录
        weights_dir = os.path.dirname(args.path_weights)
        # 构造配置文件路径
    ...
    if data['dataset'] == "VehicleID":
        ...
        list_cmc5 = []
        for i in range(10):
            reader = open(r'D:\MBR4B\vehicle_reid_itsc2023-main\dataset\VehicleID_V1.0\VehicleID_V1.0\train_test_split\test_list_800.txt')
